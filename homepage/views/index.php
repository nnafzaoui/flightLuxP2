			...
			<div class="position-absolute" id="cntfrom">
				...
				<div class="contentform" id="homepage">
					<div class="btn-group btn-group-justified" style="width:100%;" >			
						<div class="btn-group">
							<button id="button1" type="button" href="#SearchResult" class="btn btn-primary" >Search by location</button>
						</div>
						<div class="btn-group">
            ...
            ?>
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary " onclick="window.location='<?php echo $page ?>?id=<?php echo $flight->get_id(); ?>'">Show more</i></a>
						</td>
					</tr>
				<?php } ?>
				</tbody>
