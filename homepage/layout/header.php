...
<header style=" margin-bottom:10px;">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <strong class="text-primary" ><a type="submit">Hi <?php echo $_SESSION['firstname'];?></a></strong>&nbsp;
                <a class="btn btn-light" href="../views/profile.php">Profile</a>
                <a class="nav-link text-danger" href="?log=out">Logout</a>
                <?php }elseif(isset($_SESSION['id']) && $_SESSION["role"] == 'admin'){ ?>
                    <span class="btn btn-light">Hi Admin <?php echo $_SESSION['firstname'];?></span>
                </span>
                <a class="btn btn-light" href="../views/profile.php">Profile</a>
                <a class="btn btn-light" href="../views/flights_manager.php">Flights Managment</a>
                <a class="nav-link text-danger" href="?log=out">Logout</a>
                <?php }else{ ?>
					
					<a class="btn btn_light" href="login.php">Sing Up / Login</a>
                    <?php } ?>
                </form>
            </div>
        </nav>
